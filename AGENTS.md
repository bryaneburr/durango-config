...
- Durango is live on PyPI; coordinate the dorgy integration via lazy imports and shared CLI helpers, keeping Chromadb/search updates consistent and logging progress in `notes/STATUS.md`.
